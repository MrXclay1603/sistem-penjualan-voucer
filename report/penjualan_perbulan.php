...
<html>
    <head>
    <title>Cetak Data Penjualan Arsip Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <h3>DATA PENJUALAN ARSIP BULAN   <?php echo "$bulanNama $ambilthn"; ?></h3>
  ...
  <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM tb_detail_order
                                    ...
                                    JOIN user ON tb_detail_order.id_user = user.id_user WHERE substr(tgl_transaksi,1,7)='$ambilthn-$ambilbln'";
