...
<head>
    <title>Cetak Data Penjualan Arsip Pertahun</title>
        ...
        <div class='row'>
            <div class="col-sm-12">
                ...
                <div class="text-center">
                    <h3>DATA PEMINJAMAN ARSIP TAHUN
                        <?php echo "$ambilthn"; ?>
                    </h3>
                    ...
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM tb_detail_order
                                    ...
                                    JOIN user ON tb_detail_order.id_user = user.id_user WHERE substr(tgl_transaksi,1,4)='$ambilthn'";
                            ...
                            <tr>
                                ...
                                <td style="color:darkblue;background-color:lightskyblue">Rp.
                                    <strong><?= number_format($totaljual); ?></strong></td>
                                <td style="color:darkblue;background-color:lightskyblue">
                                    <strong><?= number_format($totalitem); ?> Pcs</strong></td>
                            </tr>
