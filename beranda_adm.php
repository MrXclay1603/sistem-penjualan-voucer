                     ...
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                       <thead>
                          ...
                          <p class="col-sm-12 col-xs-12" align="center">
                            Selamat datang di halaman administrator Sistem Penjualan Voucer Toko Bismillah Ponsel Kisaran.<br>
                            Melalui halaman ini dapat dilakukan pengelolaan data Voucer.<br><br>
                            Akses menu Master Data pada bagian atas sistem untuk pengelolaan data Voucer <br>
